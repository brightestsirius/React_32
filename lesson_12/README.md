...
- `isPlaceholderData` — флаг для блокування кнопки "Next" під час завантаження
...
Підписуємось тільки на потрібне поле, а не на весь стор — компонент не ре-рендериться при зміні інших полів.
